...
<body>
  ...
  <header id="home" class="header">
    ...
    <img src="./images/advert1.png" alt="banner img"  class="hero-img" /> 
    <div class="hero-content">
    <!--  <h2><span class="discount">70% </span> SALE OFF</h2> -->
      
	  <h1>
        <span>About </span>
        <span>Trendy Shoppy</span>
      </h1>
     <br><br>
	   <div class ="marquee"  >
			<marquee  direction="right" scrollamount="7" style=" height:50px;" width = "100%" onmouseover="this.stop();" onmouseout="this.start();">
				<h3 style=" color:#ff0000; ">welcome to our Website, lets get with the trend !</h3>
			</marquee>
       </div>
	   <h2><span class="discount">50+ </span> Brands</h2>
	    <h2><span class="discount">50k+ </span>Happy Customers</h2>
		 <h2><span class="discount">5 years+ </span>Service</h2>
