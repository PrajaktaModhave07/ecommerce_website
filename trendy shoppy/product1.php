...
<body>
    ...
    <section class="section all-products" id="products">
        ...
        <div class="product-center container">
            ...
            <div class="product">
                <div class="product-header">
                    <img src="./images/redshoe.jpg" alt="Red shoes">
                ...
                <div class="product-footer">
                    ...
                    <h4 class="price">800Rs/-</h4>
                </div>
            </div>
           <div class="product">
                <div class="product-header">
                    <img src="./images/blueshirt.jpg" alt="blue shirt">
			...
			<div class="product">
                <div class="product-header">
                    <img src="./images/pic7.jpg" alt="blue Trackpant">
