      ...
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          <div class="col-25" >
            ...
            <input type="text" id="fname" name="name" placeholder="enter your fullname..">
            ...
            <input type="text" id="adr" name="address" placeholder="put your address here..">
